        ...
        <div class="card uper">
          <div class="card-header">
           ...
           <center>
            ...
            <div class="form-group  <?php echo e($errors->has('appointment_datetime') ? ' has-error' : ''); ?>">
              <label for="duties" ><?php echo e(__('Appointment Date')); ?></label>
              <div class="input-group">
                <input id="appointment_datetime" type="text" class="form-control" name="appointment_datetime" value="<?php echo e(old('appointment_datetime')); ?>" placeholder="Appointment date" autocomplete="appointment_datetime">
