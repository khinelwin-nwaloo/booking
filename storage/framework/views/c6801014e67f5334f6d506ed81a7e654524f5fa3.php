...
endif; ?>" name="age" value="<?php echo e(old('age')); ?>" placeholder="Age" autocomplete="age">

        <?php if($errors->has('age')): ?>            
        <span class="help-block">
          <strong style="color:red;"><?php echo e($errors->first('age')); ?></strong>
        </span>
        <?php endif; ?>  
      </div>
...
if (isset($messageCache)) { $message = $messageCache; }
     ...
     <div class="form-group  <?php echo e($errors->has('phone_number') ? ' has-error' : ''); ?>">
      ...
      <input id="phone_number" type="text" class="form-control <?php if ($errors->has('phone_number')) :
if (isset($message)) { $messageCache = $message; }
...
if (isset($messageCache)) { $message = $messageCache; }
endif; ?>" name="address" value="<?php echo e(old('address')); ?>" placeholder="Address" autocomplete="address"></textarea>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\hospital_booking\resources\views/patient/register.blade.php ENDPATH**/ ?>